...
def start_multimon(cfg):
    ...
    call = "rtl_fm -E dc -d{} -I 0 -g 42 -p 33 -f {} -s {} | multimon-ng -t raw {} -f alpha -t raw /dev/stdin -".format(cfg.get('rtl_fm', 'device_index'), cfg.get('Frequencies', 'freq'), cfg.get('rtl_fm', 'sample_rate'), prots)
