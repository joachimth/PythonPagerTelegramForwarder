...
>Build status of continuous integration (travis, appveyor, etc.) and code style (xo, standard etc.). It's common to include [status badges](https://docs.github.com/en/actions/monitoring-and-troubleshooting-workflows/adding-a-workflow-status-badge) here so contributors and prospective end-users can see the status of your project at a glance. Just don't go too crazy or it will look like a mess.
>
...
- [BorrowBuddy](https://github.com/meg-gutshall/borrow-buddy)
- [Rxeactions](https://github.com/meg-gutshall/rxeactions)
